...
- (void)viewDidAppear:(BOOL)animated {
    ...
    selector:@selector(removeAuthenticationViewController)
     name:RemoveAuthenticationViewController
    object:nil];
...
- (void)removeAuthenticationViewController{
    ...
    [GameKitHelper sharedGameKitHelper];
    NSLog(@"removeAuthenticationViewController activated in GameNavigationController");
    [gameKitHelper.authenticationViewController dismissViewControllerAnimated:YES completion:nil];
}
